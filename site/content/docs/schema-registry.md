...
description = "Confluent-compatible schema registry integration for Avro, Protobuf and JSON Schema."
weight = 80

[extra]
slug_id = "schema-registry"
+++
...
```toml
[dependencies]
krafka = { version = "0.15.0", features = ["schema-registry"] }
```
...
```toml
[dependencies]
krafka = { version = "0.15.0", features = ["aws-glue-schema-registry"] }
```
...
- [Producer Guide](@/docs/producer.md) — sending schema-encoded records
- [Consumer Guide](@/docs/consumer.md) — consuming and decoding records
- [Authentication Guide](@/docs/authentication.md) — securing connections
