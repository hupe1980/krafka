...
Multi-version encode/decode dispatch is implemented for: CreateTopics (v2–v7), DeleteTopics (v1–v6), FindCoordinator (v1–v6), DescribeGroups (v1–v6), ListGroups (v1–v5), OffsetForLeaderEpoch (v2–v4), DescribeAcls (v1–v3), CreateAcls (v1–v3), DeleteAcls (v1–v3), ConsumerGroupDescribe (v0–v1), CreatePartitions (v0–v3), DeleteRecords (v0–v2), DescribeTopicPartitions (v0), DeleteGroups (v0–v2), DescribeCluster (v0–v2), DescribeClientQuotas (v0–v1), AlterClientQuotas (v0–v1), CreateDelegationToken (v1–v3), RenewDelegationToken (v1–v2), ExpireDelegationToken (v1–v2), DescribeDelegationToken (v1–v3), DescribeConfigs (v0–v4), IncrementalAlterConfigs (v0–v1), UpdateFeatures (v0–v1).
